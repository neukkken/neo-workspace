...
<div align="center">
  ...
  <p>
    <a href="https://github.com/neukkken/neo-workspace/releases"><img src="https://img.shields.io/badge/Release-v1.4.0-emerald?style=flat-square&logo=electron" alt="Version" /></a>
...
### Windows
- **Setup Installer:** `NeoWork-Setup-1.4.0.exe` (Recommended for automatic updates and desktop shortcuts).
- **Portable Executable:** `NeoWork-1.4.0-portable.exe` (Run directly without installation or administrator privileges).

### Linux
- **Universal AppImage:** `NeoWork-1.4.0.AppImage` (Runs on modern Linux distributions).
  ```bash
  chmod +x NeoWork-1.4.0.AppImage
  ./NeoWork-1.4.0.AppImage
  ```
- **Debian / Ubuntu Package:** `NeoWork_1.4.0_amd64.deb`
  ```bash
  sudo dpkg -i NeoWork_1.4.0_amd64.deb
  ```
